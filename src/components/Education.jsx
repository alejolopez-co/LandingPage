...
const Education = () => {
  return (
    <div name='education' className='w-full mx-auto h-auto bg-[#FFFFFE] text-[#2B2C34] sm:px-8 mt-96 mb-80'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center w-full h-full'>
        ...
        <div className='w-full grid grid-cols-1 sm:grid-cols-3 gap-4 py-8'>
          ...
          {/* Grid item */}
          <div className="grid justify-items-center md:max-w-xl rounded-lg shadow-lg bg-white text-[#2B2C34] hover:bg-[#2B2C34] hover:text-[#FFFFFE]">
